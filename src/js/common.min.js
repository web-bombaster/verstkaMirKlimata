...
// window.addEventListener('DOMContentLoaded', rangeSliderInit) // запускаем функцию init, когда документ будет загружен и готов к взаимодействию// https://github.com/dinbror/blazy/
